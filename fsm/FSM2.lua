...
return rfsm.state {
	...
	MIR = rfsm.state{
		...
		Move_Pantografo = rfsm.state{entry = function() print("Stato: MovePantografo") end},
    ...
    --Transitions
	rfsm.trans{ src = 'initial', tgt='MIR.Verso_Prelievo', pn = 0, events = {'Begin_Task_E'}},
	...
	rfsm.trans{ src = 'MIR.Avvio_Prelievo' , tgt = 'MIR.Move_Pantografo', pn = 0, events = {'MovePantografo_E'} },
	rfsm.trans{ src = 'MIR.Move_Pantografo' , tgt = 'MIR.Prelievo.Move_to_detect', pn = 0, events = {'HeightReached_E'} },
